...
int main() {
    int n = 1000000; // Количество подинтервалов

    // Интегрируем по [0, 1] и (1, 2]
    long double integral_part1 = trapezoidal_integration(f, 0.0, 1.0, n);
    long double integral_part2 = trapezoidal_integration(f, 1.0, 2.0, n);
